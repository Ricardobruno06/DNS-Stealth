      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="manage_customers_man.php"><i class="fa fa-fw fa-user"></i><span>Usuarios</span></a></li>
             <li><a href="change_password_man.php"><i class="fa fa-cog" aria-hidden="true"></i><span>Senha</span></a></li>
