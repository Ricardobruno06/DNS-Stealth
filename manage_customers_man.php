...
<body>
	...
	<div id="sb">
		...
		<div class = "left">
			<table id="tbb">
				<h2>Clientes</h2>
				<th>ClienteID</th> <th>Nome</th> <th>Email</th><th>Apagar</th>
				<?php 
					for($i=0;$i<sizeof($result);$i++){
						...
						echo "<tr>
							...
							<td>$name</td>
							<td>$email</td>
							<td><a href='manage_customers_man.php?did=$id'>Apagar</a></td>
						 </tr>";
					}
				 ?>
			</table>
...
<div class="col-md-6">
	<div class="box box-primary">
                ...
                <!-- form start -->
                <form action="manage_customers_man.php" method="POST">
